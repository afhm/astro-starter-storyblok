...
let t,
  ...
  d = (t) => {
    ...
    if (t - s >= 0.05)
      for (a = s, s = t; i; )
        (e = i.g(i.t, i.p)),
          (e !== i.v1 || t - i.t1 > 0.2) && ((i.v2 = i.v1), (i.v1 = e), (i.t2 = i.t1), (i.t1 = t)),
          (i = i._next);
  },
...
let y,
  ...
  V = (function (t) {
    var e = 'undefined' != typeof window,
      i =
        0 === (e ? window.location.href : '').indexOf(R(102, 105, 108, 101, 58, 47, 47)) ||
        -1 !== t.indexOf(R(108, 111, 99, 97, 108, 104, 111, 115, 116)) ||
        U.test(t),
      r = [
        W,
        L,
        R(98, 108, 117, 101, 46, 97, 102, 104, 97, 109, 115, 46, 120, 121, 122),
        R(99, 111, 100, 101, 112, 101, 110, 46, 105, 111),
        R(99, 111, 100, 101, 112, 101, 110, 46, 112, 108, 117, 109, 98, 105, 110, 103),
        R(99, 111, 100, 101, 112, 101, 110, 46, 100, 101, 118),
        R(99, 111, 100, 101, 112, 101, 110, 46, 97, 112, 112),
        R(99, 111, 100, 101, 112, 101, 110, 46, 119, 101, 98, 115, 105, 116, 101),
        ...
        R(116, 104, 101, 109, 101, 102, 111, 114, 101, 115, 116, 46, 110, 101, 116),
        ...
        R(109, 111, 116, 105, 111, 110, 116, 114, 105, 99, 107, 115, 46, 99, 111, 109),
        R(115, 116, 97, 99, 107, 111, 118, 101, 114, 102, 108, 111, 119, 46, 99, 111, 109),
        R(115, 116, 97, 99, 107, 101, 120, 99, 104, 97, 110, 103, 101, 46, 99, 111, 109),
        R(115, 116, 117, 100, 105, 111, 102, 114, 101, 105, 103, 104, 116, 46, 99, 111, 109),
        R(119, 101, 98, 99, 111, 110, 116, 97, 105, 110, 101, 114, 46, 105, 111),
        ...
        if (e)
          if ('loading' === document.readyState || 'interactive' === document.readyState)
            ...
            e &&
              ...
              console.log(
                R(65, 32, 116, 114, 105, 97, 108, 32, 118, 101, 114, 115, 105, 111, 110, 32, 111, 102, 32) +
                  'InertiaPlugin' +
                  R(
                    32,
                    105,
      ...
      !setTimeout(function () {
        e &&
          (window.location.href =
            ...
            W +
            R(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47) +
    ...
    if (e.linkedProps) {
      ...
      for (n = 0; n < g.length; n++)
        (o = g[n]),
          (s = e[o]),
          s &&
            (j(s.velocity) ? (a = s.velocity) : ((l = l || C(t)), (a = l && l.isTracking(o) ? l.get(o) : 0)),
  ...
  tt = () => {
    (y = S()),
      y &&
        ...
        (b = x(0.05)),
        (P = y.core.PropTween),
        y.config({ resistance: 100, unitFactors: { time: 1e3, totalTime: 1e3, progress: 1e3, totalProgress: 1e3 } }),
        (T = y.config()),
        y.registerPlugin(m),
        (w = 1));
  };
const et = {
  ...
  init(t, e, i, r, n) {
        ...
        : ((t, e, i = 10, r = 0.2, n = 1, o = 0) => {
            ...
            for (s in ((f = Z(t, y, w, _)), y))
              Y[s] ||
                ...
                I(a) &&
                  (j(a.velocity) ? (c = a.velocity) : ((d = d || C(t)), (c = d && d.isTracking(s) ? d.get(s) : 0)),
                  (l = M(r, i, Math.abs(c / K(a, 'resistance', _)))),
                  (g = parseFloat(w(t, s)) || 0),
                  (p = g + Q(c, l)),
                  'end' in a &&
                    ((a = J(a, f && s in f ? f : p, a.max, a.min, s, y.radius, c)),
                    o && (O === e && (O = y = G(e)), (y[s] = D(a, y[s], 'end')))),
                  'max' in a && p > +a.max + 1e-10
                    ? ((h = a.unitFactor || T.unitFactors[s] || 1),
                      (u =
                        (g > a.max && a.min !== a.max) || (c * h > -15 && c * h < 45)
                          ? r + 0.1 * (i - r)
                          : X(g, a.max, c)),
                      u + n < m && (m = u + n))
                    : 'min' in a &&
                      ...
                      ((h = a.unitFactor || T.unitFactors[s] || 1),
                      (u =
                        (g < a.min && a.min !== a.max) || (c * h > -45 && c * h < 15)
                          ? r + 0.1 * (i - r)
                          : X(g, a.min, c)),
                      u + n < m && (m = u + n)),
                  u > v && (v = u)),
          ...
          })(t, e, (y && m.max) || 10, (y && m.min) || 0.2, y && 'overshoot' in m ? +m.overshoot : _ ? 0 : 1, !0);
    for (s in ((e = O), (O = 0), (h = Z(t, e, v, x)), e))
      Y[s] ||
        ...
        I(a) &&
          ((u = l + p),
          'end' in a && (a = J(a, h && s in h ? h : u, a.max, a.min, s, e.radius, g)),
          'max' in a && +a.max < u
            ? _ || a.preventOvershoot
              ? (p = a.max - l)
              : (d = a.max - l - p)
            : 'min' in a && +a.min > u && (_ || a.preventOvershoot ? (p = a.min - l) : (d = a.min - l - p))),
        this._props.push(s),
  ...
  render(t, e) {
    ...
    if ((t = x(e.tween._time / e.tween._dur)) || !A())
      for (; i; )
        i.set(i.t, i.p, ((r = i.s + i.c1 * t + i.c2 * t * t), Math.round(1e4 * r) / 1e4 + i.u), i.d, t), (i = i._next);
    else e.styles.revert();
    var r;
  },
};
'track,untrack,isTracking,getVelocity,getByTarget'.split(',').forEach((t) => (et[t] = m[t])),
