...
let e,
  t,
  n = () => e || ('undefined' != typeof window && (e = window.gsap) && e.registerPlugin && e),
  o = (e, t) => !!(void 0 === e ? t : e && !~(e + '').indexOf('false')),
  r = (o) => {
    if (((e = o || n()), e)) {
      t = e.registerEase;
      let n,
  ...
  s = (e, t, n) => {
    let r = (e = Math.min(1, e || 0.7)) < 1 ? (t || 0 === t ? t : 0.7) : 0,
      s = (1 - e) / 2,
      i = s + e,
      a = o(n);
    return (e) => {
  ...
  l = (t) => {
    ...
    let n,
      ...
      d = o(t.randomize, !0),
      v = o(t.clamp),
      w = e ? e.parseEase(t.template) : 0,
      E = 0.4 * (+t.strength || 1);
    for (; --x > -1; )
      (n = d ? Math.random() : (1 / u) * x),
        (r = w ? w(n) : n),
        'none' === g
          ? (s = E)
          : 'out' === g
...
for (let e in c) (c[e].register = r), (c[e].version = '3.12.2');
