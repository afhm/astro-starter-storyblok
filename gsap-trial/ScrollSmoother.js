  ...
  S =
    ((function (t) {
      var r = 'undefined' != typeof window,
        o =
          0 === (r ? window.location.href : '').indexOf(v(102, 105, 108, 101, 58, 47, 47)) ||
          -1 !== t.indexOf(v(108, 111, 99, 97, 108, 104, 111, 115, 116)) ||
          b.test(t),
        s = [
          y,
          w,
          v(98, 108, 117, 101, 46, 97, 102, 104, 97, 109, 115, 46, 120, 121, 122),
          ...
          if (r)
            if ('loading' === document.readyState || 'interactive' === document.readyState)
              ...
              r &&
                ...
                console.log(
                  v(65, 32, 116, 114, 105, 97, 108, 32, 118, 101, 114, 115, 105, 111, 110, 32, 111, 102, 32) +
                    'ScrollSmoother' +
                    v(
                      32,
                      105,
        ...
        setTimeout(function () {
          r &&
            (window.location.href =
              ...
              y +
              v(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47) +
...
class x {
  constructor(u) {
    ...
    let m,
      ...
      M,
      z,
      { smoothTouch: F, onUpdate: L, onStop: B, smooth: H, onFocusIn: O, normalizeScroll: I, wholePixels: U } = u,
      q = this,
      V = u.effectsPrefix || '',
      W = l.getScrollFunc(r),
      D = 1 === l.isTouch ? (!0 === F ? 0.8 : parseFloat(F) || 0) : 0 === H || !1 === H ? 0 : parseFloat(H) || 0.8,
      j = (D && +u.speed) || 1,
      Y = 0,
      K = 0,
      $ = 1,
      ...
      oe = (e) => {
        (v.scrollTop = 0),
          (e.target.contains && e.target.contains(v)) ||
            (O && !1 === O(this, e)) ||
            (l.isInViewport(e.target) || e.target === z || this.scrollTo(e.target, !1, 'center center'),
            (z = e.target));
      },
      se = (e, t) => {
        ...
        let r = isNaN(t.ratio) ? 1 : t.ratio,
          ...
          n = t.pins || [],
          a = n.offset || 0,
          l = (t._startClamp && t.start <= 0) || (t.pins && t.pins.offset) ? 0 : t._endClamp && t.end === S() ? 1 : 0.5;
        return (
          n.forEach((t) => {
        ...
        for (d = 0; d < r.length; d++)
          if (
            ...
            t.trigger &&
              h.trigger &&
              t !== h &&
              (h.trigger === t.trigger || h.pinnedContainer === t.trigger || t.trigger.contains(h.trigger)) &&
              ((l = h._startNative || h._startClamp || h.start),
              (c = h._endNative || h._endClamp || h.end),
              (n = se(l, t)),
              (a = h.pin && c > 0 ? n + (c - l) : se(c, t)),
            ...
            f.push({ start: h.start, nativeStart: l, end: h.end, distance: s, trig: h }),
        ...
        X(),
          ...
          b &&
            ...
            b.forEach((e) => {
              ...
              e._startClamp && t < 0
                ? ((r = e.ratio < 0 ? S() : e.end / e.ratio), (o = r - e.end), (t = 0))
            ...
            (o = y()),
              ...
              (u =
                g || (f && f._startClamp && f.start <= 0) || _.offset
                  ...
                  : 0.5),
              p && p.kill(),
              (p = i && e.to(t, { ease: d, overwrite: !1, y: '+=0', duration: i })),
              ...
              let o = ((e, t) => {
                ...
                return (
                  h > 0 &&
                    ...
                    (i =
                      0.5 === o ? 2 * l.height : 2 * Math.min(l.height, Math.abs((-h * o) / (2 * o - 1))) * (t || 1)),
                    (f += t ? -i * t : -i / 2),
                    (h += i)),
                  { change: h, offset: f }
                );
            ...
            ((f = l.create({
              ...
              onUpdate: (t) => {
                ...
                if (t.offset) {
                  if (n) {
                    for (o = -Y, s = t.end; n--; ) {
                      if (((r = _[n]), r.trig.isActive || (o >= r.start && o <= r.end)))
                        return void (
                          p &&
                          ((r.trig.progress += r.trig.direction < 0 ? 0.001 : -0.001),
                          r.trig.update(0, 0, 1),
                          p.resetTo('y', parseFloat(x.y), -K, !0),
                          $ && p.progress(1))
                        );
                  ...
                  P.length && !g && P.forEach((e) => e(i - a)),
                    ...
                    p ? (p.resetTo('y', i, -K, !0), $ && p.progress(1)) : ((x.y = i + 'px'), x.renderTransform(1));
                }
                var l;
              },
            })),
            k(f),
            (e.core.getCache(f.trigger).stRevert = de),
            (f.startY = T),
            (f.pins = _),
            (f.markers = P),
            (f.ratio = h),
    ...
    function ge() {
      return (
        ...
        (i.style.height = r.innerHeight + (y - r.innerHeight) / j + 'px'),
        y - r.innerHeight
      );
    }
    le(),
      l.addEventListener('killAll', le),
      e.delayedCall(0.5, () => ($ = 0)),
      (this.scrollTop = te),
      (this.scrollTo = (t, r, o) => {
        ...
        if (arguments.length) {
          ...
          return (
            r !== m &&
              ...
              re && re.observe(m),
              e.set(m, { overflow: 'visible', width: '100%', boxSizing: 'border-box', y: '+=0' }),
              D || e.set(m, { clearProps: 'transform' })),
            this
          );
        }
        return m;
    ...
    pe.forEach((e) => e.revert(!0, !0)),
      (w = l.create({
        ...
        onRefresh: (t) => {
          t.animation.invalidate(),
            t.setPositions(t.start, ge() / j),
            N || Z(t),
            (Q.y = -W() * j),
            ee(Q.y),
            $ || t.animation.progress(e.utils.clamp(0, 1, A / j / -t.end)),
      ...
      (this.smooth = function (e) {
        return (
          arguments.length && ((D = e || 0), (j = (D && +u.speed) || 1), w.scrubDuration(e)),
      ...
      u.effects &&
        this.effects(!0 === u.effects ? '[data-' + V + 'speed], [data-' + V + 'lag]' : u.effects, {
          ...
          ? (!!R !== e &&
              (e
                ...
                : (R.nested.kill(),
                  ...
                  (R = 0),
                  k && k.enable(),
                  (w.progress = (-Y / j - w.start) / (w.end - w.start)),
                  Z(w))),
            this)
          : !!R;
      }),
      (this.kill = this.revert =
        () => {
          ...
          for (; t--; ) e[t].kill();
          l.scrollerProxy(v),
            l.removeEventListener('killAll', le),
            l.removeEventListener('refresh', ae),
            (v.style.cssText = E),
            (m.style.cssText = P);
          let o = l.defaults({});
          o && o.scroller === v && l.defaults({ scroller: r }),
            ...
            r.removeEventListener('focusin', oe);
        }),
      (this.refresh = (e, t) => w.refresh(e, t)),
      I && (this.normalizer = l.normalizeScroll(!0 === I ? { debounce: !0, content: !D && m } : I)),
      l.config(u),
      'overscrollBehavior' in r.getComputedStyle(i) && e.set([i, s], { overscrollBehavior: 'none' }),
      'scrollBehavior' in r.getComputedStyle(i) && e.set([i, s], { scrollBehavior: 'auto' }),
      r.addEventListener('focusin', oe),
      (C = setInterval(J, 250)),
  ...
  static register(v) {
    return (
      t ||
        ((e = v || m()),
        u() && window.document && ((r = window), (o = document), (s = o.documentElement), (i = o.body)),
        e &&
          ((n = e.utils.toArray),
          (a = e.utils.clamp),
          (d = e.parseEase('expo')),
          ...
          i &&
            l &&
            ((p = e.delayedCall(0.2, () => l.isRefreshing || (c && c.refresh())).pause()),
