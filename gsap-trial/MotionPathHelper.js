...
function d(t, e, s, i, n, o, r) {
  ...
  for (; --g > -1; )
    for (a = t[g], h = a.length, l = 0; l < h; l += 2)
      (c = a[l]), (d = a[l + 1]), (a[l] = c * e + d * i + o), (a[l + 1] = c * s + d * n + r);
  return (t._dirty = 1), t;
}
function g(t, e, s, h, l, c, d, g, p) {
  ...
  for (V = 0; V < z.length; V += 2)
    (A = z[V]), (w = z[V + 1]), (z[V] = A * B + w * U + H), (z[V + 1] = A * F + w * Z + N);
...
function p(t) {
  ...
  for (i = 0; i < x; i++)
    if (
      ...
      c || (c = [0, 0]),
        l || (w = P = 0),
        c.push(o, a, w + 1 * y[i + 3], P + 1 * y[i + 4], (w += 1 * y[i + 5]), (P += 1 * y[i + 6])),
        (i += 6);
    else if ('S' === h)
      (u = w),
        (_ = P),
        ('C' !== m && 'S' !== m) || ((u += w - c[c.length - 4]), (_ += P - c[c.length - 3])),
        l || (w = P = 0),
      ...
      (u = w - c[c.length - 4]),
        (_ = P - c[c.length - 3]),
        c.push(w + u, P + _, o + (2 / 3) * (w + 1.5 * u - o), a + (2 / 3) * (P + 1.5 * _ - a), (w = o), (P = a)),
        (i += 2);
    else if ('H' === h) E(w, P, (w = o), P), (i += 1);
    else if ('V' === h) E(w, P, w, (P = o + (l ? P - w : 0))), (i += 1);
    else if ('L' === h || 'Z' === h)
      'Z' === h && ((o = d), (a = p), (c.closed = !0)),
        ('L' === h || r(w - o) > 0.5 || r(P - a) > 0.5) && (E(w, P, o, a), 'L' === h && (i += 2)),
        (w = o),
        (P = a);
    else if ('A' === h) {
      if (
        ...
        (n = 7),
        b.length > 1 &&
          (b.length < 3 ? ((_ = u), (u = v), n--) : ((_ = v), (u = b.substr(2)), (n -= 2)),
          (v = b.charAt(1)),
          (b = b.charAt(0))),
        (f = g(w, P, +y[i + 1], +y[i + 2], +y[i + 3], +b, +v, (l ? w : 0) + 1 * u, (l ? P : 0) + 1 * _)),
        (i += n),
        f)
      )
  ...
  return (
    (i = c.length),
    i < 6 ? (A.pop(), (i = 0)) : c[0] === c[i - 2] && c[1] === c[i - 1] && (c.closed = !0),
    (A.totalPoints = C + i),
    A
  );
}
function u(t, e, s, i, n, o, a, h, l, c, d) {
  ...
  return (
    ...
    (k + M) * (k + M) > l * (S * S + E * E) &&
      ((g = c.length), u(t, e, p, _, y, A, x, C, l, c, d), u(x, C, w, P, b, v, a, h, l, c, d + 2 + (c.length - g))),
    c
  );
}
function _(t, e) {
  ...
  for (
    k && (t.push(P, x), (P = A), (x = w), (A = t[y - 2]), (w = t[y - 1]), t.unshift(A, w), (y += 4)),
      e = e || 0 === e ? +e : 1,
      n = 2;
    n < y;
    n += 2
    ...
    (s = A),
      ...
      (A === P && w === x) ||
        ...
        (A === s && w === i) || C.push(h(u + f), h(m + v), h(A), h(w), h(_ + f), h(b + v)));
  return (
    A !== P || w !== x || C.length < 4 ? C.push(h(P), h(x), h(P), h(x)) : (C.length -= 2),
    2 === C.length ? C.push(A, w, A, w, A, w) : k && (C.splice(0, 6), (C.length = C.length - 6)),
    C
  );
}
...
function b(e, s, i, n, o, r, a, h, l, c, d, g, p, u) {
  ...
  for (t = 1e8; x <= o; )
    (A = 1 - x),
      (_ = A * A * A * a + 3 * A * A * x * l + 3 * A * x * x * d + x * x * x * p),
      (f = A * A * A * h + 3 * A * A * x * c + 3 * A * x * x * g + x * x * x * u),
      (v = _ - s),
      (y = f - i),
      (m = v * v + y * y),
      m < t && ((t = m), (P = x)),
...
let v,
  ...
  T = [],
  H = [],
  N = (t) => t.ownerSVGElement || ('svg' === (t.tagName + '').toLowerCase() ? t : null),
        ...
        e &&
          (s
            ...
            : (P || ((P = L(t)), (P.style.cssText = a)),
              (h.style.cssText = a + 'width:0.1px;height:0.1px;top:' + r + 'px;left:' + o + 'px'),
              P.appendChild(h))),
        h
      );
    }
  ...
  X = (t, e) => {
    ...
    if ((c.length || c.push(L(t, 1), L(t, 2), L(t, 3)), (s = h ? x : P), h))
      l
        ...
        s.setAttribute(
          'transform',
          'matrix(' + i.a + ',' + i.b + ',' + i.c + ',' + i.d + ',' + (i.e + o) + ',' + (i.f + r) + ')'
        );
    else {
      if (((o = r = 0), E))
        for (i = t.offsetParent, n = t; n && (n = n.parentNode) && n !== i && n.parentNode; )
          (y.getComputedStyle(n)[k] + '').length > 4 && ((o = n.offsetLeft), (r = n.offsetTop), (n = 0));
      if (((a = y.getComputedStyle(t)), 'absolute' !== a.position && 'fixed' !== a.position))
        for (i = t.offsetParent; d && d !== i; ) (o += d.scrollLeft || 0), (r += d.scrollTop || 0), (d = d.parentNode);
      (n = s.style),
...
function q(t, e, s, i) {
  ...
  let n = ((t) => {
      ...
      for (; t && t !== w; )
        (s = t._gsap),
          ...
          s &&
            ...
            !s.scaleY &&
            s.renderTransform &&
            ((s.scaleX = s.scaleY = 1e-4), s.renderTransform(1, s), e ? e.push(s) : (e = [s])),
          (t = t.parentNode);
      return e;
    })(t),
    o = N(t) ? T : H,
    ...
    g = new I(
      ...
      (l.left - a.left) / 100,
      (l.top - a.top) / 100,
      a.left + (d ? 0 : y.pageXOffset || v.scrollLeft || A.scrollLeft || w.scrollLeft || 0),
      a.top + (d ? 0 : y.pageYOffset || v.scrollTop || A.scrollTop || w.scrollTop || 0)
    );
...
let Y,
  ...
  ut = (t, e, s) => {
    ...
    for (i in (((s = s || {}).class = s.class || 'path-editor'), s))
      void 0 !== n.style[i] ? (n.style[i] = s[i]) : n.setAttributeNS(null, i.replace(o, '$1-$2').toLowerCase(), s[i]);
  ...
  yt = (t, e, s, i) => {
    if (t.addEventListener) {
      ...
      (i = i || { passive: !1 }),
        ...
        n && e !== n && 'pointer' !== n.substr(0, 7) && t.addEventListener(e, s, i);
  ...
  Et = (t) => {
    (Y = document),
      (j = window),
      (z = Y.body),
      (G = G || t || j.gsap || console.warn('Please gsap.registerPlugin(PathEditor)')),
      ...
      Y.addEventListener(
        ...
        function (t) {
          ...
          if ('Shift' === r || 16 === o) U = !0;
          ...
          else if ('Alt' === r || 18 === o) for (F = !0, e = dt.length; --e > -1; ) dt[e]._onPressAlt();
            ...
            if ((ht.shift(), (s = ht[0]), s)) {
              for (
                ...
                -1 !== s.selectedIndexes.indexOf(i[e].i) && n._selectedAnchors.push(i[e]);
          ...
          else if (('a' === r || 65 === o) && (Z || B)) for (e = dt.length; --e > -1; ) dt[e].select(!0);
        },
        !0
      ),
      Y.addEventListener(
  ...
  kt = function (t) {
    ...
    (this._matrix = this.target.transform.baseVal.getItem(0).matrix),
      (this._ctm = n),
      Q[t.type]
        ? ((e = -1 !== t.type.indexOf('touch') ? t.currentTarget || t.target : Y),
      ...
      1 === this._ctm.a && 0 === this._ctm.b && 0 === this._ctm.c && 1 === this._ctm.d
        ? (this._ctm = null)
        : ((s = i._startPointerX * this._ctm.a + i._startPointerY * this._ctm.c + this._ctm.e),
          (i._startPointerY = i._startPointerX * this._ctm.b + i._startPointerY * this._ctm.d + this._ctm.f),
          (i._startPointerX = s)),
      (i.isPressed = ot = !0),
  ...
  Dt = function (t, e) {
    ...
    if (
      ...
      V || (At(Y, 'mouseup', s._onRelease), t && t.target && At(t.target, 'mouseup', s._onRelease)),
      r ? (s.isDragging = !1) : s.vars.onClick && s.vars.onClick.call(s.vars.callbackScope || s, o),
      t)
    ) {
    ...
    return (
      o && !r && s.vars.onDragRelease
        ...
        : (o && gt(o), s.vars.onRelease && s.vars.onRelease.call(s.vars.callbackScope || s, s.pointerEvent)),
      r && s.vars.onDragEnd && s.vars.onDragEnd.call(s.vars.callbackScope || s, s.pointerEvent),
      !0
    );
  },
  Tt = (t, e, s, i) => {
...
class Nt {
  ...
  setPointerPosition(t, e) {
    ...
    (this.pointerX = t),
      ...
      this.snap && !U && ((lt.x = n), (lt.y = o), this.snap.call(this, lt), (n = lt.x), (o = lt.y)),
      (this.x === n && this.y === o) ||
        ((this._matrix.f = this.y = o),
        (this._matrix.e = this.x = n),
        !this.isDragging && this.isPressed && ((this.isDragging = !0), Ct('onDragStart', this, this.pointerEvent)));
  }
  enabled(t) {
  ...
  update(t, e, s) {
    ...
    (this.segment = n),
      (this.smooth =
        s > 0 &&
        s < n.length - 2 &&
        Math.abs(Math.atan2(n[s + 1] - n[o + 1], n[s] - n[o]) - Math.atan2(n[s + 3] - n[s + 1], n[s + 2] - n[s])) < 0.09
          ? 2
          : 0),
      this.smooth !== i &&
        this.element.setAttribute('d', this.smooth ? this.editor._circleHandle : this.editor._squareHandle),
      this.element.setAttribute('transform', 'translate(' + n[s] + ',' + n[s + 1] + ')');
  }
}
class Lt {
  constructor(t, e) {
    (e = e || {}),
      ...
      (this._g = ut('g', this.path.ownerSVGElement, { class: 'path-editor-g path-editor' })),
      ...
      (this._selection = e._selection || ut('g', this._g, { class: 'path-editor-selection path-editor' })),
    ...
    (this._squareHandle = ((t) => ['M-' + (t = mt(t)), -t, t, -t, t, t, -t, t + 'z'].join(','))(i)),
    ...
    !1 !== e.draggable &&
      ...
      this._saveState(),
      V ||
        (yt(this._selectionHittest, 'mousedown', xt(this._onClickSelectionPath, this)),
        yt(this._selectionHittest, 'mouseup', xt(this._onRelease, this))),
      yt(this._selectionHittest, 'touchstart', xt(this._onClickSelectionPath, this)),
  ...
  init() {
    ...
    if (((this._rawPath = i), o)) {
      if (((this._anchors = Tt(i, 0, this, r)), (t = i.length), t > 1))
        for (e = 1; e < t; e++) this._anchors = this._anchors.concat(Tt(i, e, this, r));
    ...
    if ('hidden' === this._selection.style.visibility) this.select();
      ...
      for (
        this._draggable && this._draggable._onRelease(e),
          c && ((o = e.clientX * c.a + e.clientY * c.c + c.e), (r = e.clientX * c.b + e.clientY * c.d + c.f)),
          a = (function (e, s, i, n) {
            let o,
              r,
              a,
  ...
  _onPressAnchor(t) {
    -1 === this._selectedAnchors.indexOf(t)
      ...
      : U && (this._selectedAnchors.splice(this._selectedAnchors.indexOf(t), 1), t._draggable.endDrag()),
      (at.x = t.segment[t.i]),
      ...
      ? ((t.smooth = !t.smooth),
        ...
        !t.smooth || (c && !t.isClosedStart)
          ...
          : ((e = Math.atan2(h[a + 1] - h[l + 1], h[a] - h[l])),
            ...
            (i = Ht(h, l, a)),
            (n = Ht(h, a, a + 2)),
            i < 0.2 && ((i = Ht(h, a, l - 4) / 4), (e = s || Math.atan2(h[a + 7] - h[l - 3], h[a + 6] - h[l - 4]))),
            n < 0.2 && ((n = Ht(h, a, a + 6) / 4), (s = e || Math.atan2(h[a + 7] - h[l - 3], h[a + 6] - h[l - 4]))),
            (o = Math.sin(e)),
            (r = Math.cos(e)),
  ...
  _updateAnchors() {
    ...
    for (this._editingAnchor = i, t = 0; t < this._anchors.length; t++)
      this._anchors[t].element.style.fill =
        -1 !== this._selectedAnchors.indexOf(this._anchors[t]) ? '#4e7fff' : 'white';
    i &&
      ...
      i && (t || i.isClosedStart)
        ? ((e = i.isClosedStart ? n[n.length - 4] : n[t - 2]),
          ...
          this._handle1.setAttribute('transform', 'translate(' + e + ',' + s + ')'),
          this._line1.setAttribute('points', e + ',' + s + ',' + n[t] + ',' + n[t + 1]))
      ...
      i && t < n.length - 2
        ? ((e = n[t + 2]),
          ...
          (this._handle2.style.visibility = this._line2.style.visibility =
            F || e !== n[t] || s !== n[t + 1] ? 'visible' : 'hidden'),
          this._handle2.setAttribute('transform', 'translate(' + e + ',' + s + ')'),
          this._line2.setAttribute('points', n[t] + ',' + n[t + 1] + ',' + e + ',' + s))
        : (this._handle2.style.visibility = this._line2.style.visibility = 'hidden');
  }
  _onPressAlt() {
    let t = this._editingAnchor;
    t &&
      ((t.i || t.isClosedStart) && (this._handle1.style.visibility = this._line1.style.visibility = 'visible'),
      t.i < t.segment.length - 2 && (this._handle2.style.visibility = this._line2.style.visibility = 'visible'));
  }
  _onReleaseAlt() {
    let t,
      e,
  ...
  _onPressHandle1() {
    this._editingAnchor.smooth &&
      (this._oppositeHandleLength = Ht(this._editingAnchor.segment, this._editingAnchor.i, this._editingAnchor.i + 2)),
      Ct('onPress', this);
  }
  _onPressHandle2() {
    this._editingAnchor.smooth &&
      (this._oppositeHandleLength = Ht(
        ...
        this._editingAnchor.isClosedStart ? this._editingAnchor.segment.length - 4 : this._editingAnchor.i - 2,
  ...
  _onDragAnchor(t, e, s) {
    ...
    for (n = 0; n < l; n++)
      (r = h[n]),
        ...
        (o = r.segment),
        i
          ? ((o[i - 2] = (((o[i - 2] + e) * c) | 0) / c), (o[i - 1] = (((o[i - 1] + s) * c) | 0) / c))
          : r.isClosedStart &&
            ((a = o.length - 2),
            (o[a] = mt(o[a] + e)),
            (o[a + 1] = mt(o[a + 1] + s)),
        ...
        (o[i] = (((o[i] + e) * c) | 0) / c),
        (o[i + 1] = (((o[i + 1] + s) * c) | 0) / c),
        i < o.length - 2 && ((o[i + 2] = (((o[i + 2] + e) * c) | 0) / c), (o[i + 3] = (((o[i + 3] + s) * c) | 0) / c)),
        r !== t && r.element.setAttribute('transform', 'translate(' + o[i] + ',' + o[i + 1] + ')');
    this.update();
  }
  enabled(t) {
    if (!arguments.length) return this._enabled;
    ...
    if (
      ...
      a &&
        ...
        (e || a.isClosedStart) &&
          ...
          (i = s[o]),
          (n = s[o + 1]),
          this._handle1.setAttribute('transform', 'translate(' + i + ',' + n + ')'),
          this._line1.setAttribute('points', i + ',' + n + ',' + s[e] + ',' + s[e + 1])),
        e < s.length - 2 &&
          ((i = s[e + 2]),
          (n = s[e + 3]),
          this._handle2.setAttribute('transform', 'translate(' + i + ',' + n + ')'),
          this._line2.setAttribute('points', s[e] + ',' + s[e + 1] + ',' + i + ',' + n))),
      t)
    )
      r = this.path.getAttribute('d');
    else {
      for (e = 0; e < this._rawPath.length; e++)
        (s = this._rawPath[e]), s.length > 7 && (r += 'M' + s[0] + ',' + s[1] + 'C' + s.slice(2).join(','));
    ...
    if (t) {
      ...
      return (function (t) {
        ...
        let e,
          ...
          r = t.length;
        for (s = 0; s < r; s++) {
          for (n = t[s], o += 'M' + h(n[0]) + ',' + h(n[1]) + ' C', e = n.length, i = 2; i < e; i++)
            o +=
              h(n[i++]) + ',' + h(n[i++]) + ' ' + h(n[i++]) + ',' + h(n[i++]) + ' ' + h(n[i++]) + ',' + h(n[i]) + ' ';
          n.closed && (o += 'z');
        }
        return o;
  ...
  getNormalizedSVG(t, e, s, i) {
    let n,
      ...
      _ = 1 / (c[p - 2] + d),
      f = -t || c[p - 1] + g;
    for (ct.length = 0, f = f ? 1 / f : -_, _ *= 1e3, f *= 1e3, o = 0; o < p; o += 2)
      (ct[o] = (((c[o] + d) * _) | 0) / 1e3), (ct[o + 1] = (((c[o + 1] + g) * f) | 0) / 1e3);
    if (i) {
      for (n = [], p = ct.length, o = 2; o < p; o += 6)
        (r = ct[o - 2]),
          ...
          (l = ct[o + 5]),
          n.push(r, a, h, l),
          u(r, a, ct[o], ct[o + 1], ct[o + 2], ct[o + 3], h, l, 0.001, n, n.length - 2);
    ...
    return s && 8 === p && 0 === ct[0] && 0 === ct[1] && 1 === ct[p - 2] && 1 === ct[p - 1]
      ? ct.slice(2, 6).join(',')
...
(Lt.simplifyPoints = m),
  ...
  (Lt.simplifySVG = (t, e) => {
    ...
    if (
      ...
      ('#' !== t.charAt(0) && '.' !== t.charAt(0)) || ((s = Y.querySelector(t)), s && (t = s.getAttribute('d'))),
      ...
      for (l = i, i = [], g = l.length, n = 2; n < g; n += 6)
        (o = +l[n - 2]),
          ...
          u(o, a, +l[n], +l[n + 1], +l[n + 2], +l[n + 3], r, h, 1 / (2e5 * c), i, i.length - 2);
    ...
    return (
      ...
      (t) => {
        let s,
          ...
          u = t.x,
          _ = t.y;
        (a && u < i) || (g = u - i) * g < e ? (u = i) : ((a && u > o) || (g = o - u) * g < e) && (u = o),
          (h && _ < n) || (p = _ - n) * p < e ? (_ = n) : ((h && _ > r) || (p = r - _) * p < e) && (_ = r),
          l && ((g = u - l.x), (p = _ - l.y), g * g < e && (u = l.x), p * p < e && (_ = l.y)),
          c &&
...
let Xt,
  ...
  Ft = Bt(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109),
  Ut = Bt(103, 115, 97, 112, 46, 99, 111, 109),
  Zt = /^(?:[0-9]{1,3}\.){3}[0-9]{1,3}:?\d*$/,
  $t =
    ((function (t) {
      var e = 'undefined' != typeof window,
        s =
          0 === (e ? window.location.href : '').indexOf(Bt(102, 105, 108, 101, 58, 47, 47)) ||
          -1 !== t.indexOf(Bt(108, 111, 99, 97, 108, 104, 111, 115, 116)) ||
          Zt.test(t),
        i = [
          Ft,
          Ut,
          Bt(99, 111, 100, 101, 112, 101, 110, 46, 105, 111),
          Bt(99, 111, 100, 101, 112, 101, 110, 46, 112, 108, 117, 109, 98, 105, 110, 103),
          Bt(99, 111, 100, 101, 112, 101, 110, 46, 100, 101, 118),
          Bt(99, 111, 100, 101, 112, 101, 110, 46, 97, 112, 112),
          Bt(99, 111, 100, 101, 112, 101, 110, 46, 119, 101, 98, 115, 105, 116, 101),
          Bt(112, 101, 110, 115, 46, 99, 108, 111, 117, 100),
          Bt(99, 115, 115, 45, 116, 114, 105, 99, 107, 115, 46, 99, 111, 109),
          Bt(99, 100, 112, 110, 46, 105, 111),
          Bt(112, 101, 110, 115, 46, 105, 111),
          Bt(103, 97, 110, 110, 111, 110, 46, 116, 118),
          Bt(99, 111, 100, 101, 99, 97, 110, 121, 111, 110, 46, 110, 101, 116),
          Bt(116, 104, 101, 109, 101, 102, 111, 114, 101, 115, 116, 46, 110, 101, 116),
          Bt(99, 101, 114, 101, 98, 114, 97, 120, 46, 99, 111, 46, 117, 107),
          Bt(116, 121, 109, 112, 97, 110, 117, 115, 46, 110, 101, 116),
          Bt(116, 119, 101, 101, 110, 109, 97, 120, 46, 99, 111, 109),
          Bt(112, 108, 110, 107, 114, 46, 99, 111),
          Bt(104, 111, 116, 106, 97, 114, 46, 99, 111, 109),
          Bt(119, 101, 98, 112, 97, 99, 107, 98, 105, 110, 46, 99, 111, 109),
          Bt(97, 114, 99, 104, 105, 118, 101, 46, 111, 114, 103),
          Bt(99, 111, 100, 101, 115, 97, 110, 100, 98, 111, 120, 46, 105, 111),
          Bt(99, 115, 98, 46, 97, 112, 112),
          Bt(115, 116, 97, 99, 107, 98, 108, 105, 116, 122, 46, 99, 111, 109),
          Bt(115, 116, 97, 99, 107, 98, 108, 105, 116, 122, 46, 105, 111),
          Bt(99, 111, 100, 105, 101, 114, 46, 105, 111),
          Bt(109, 111, 116, 105, 111, 110, 116, 114, 105, 99, 107, 115, 46, 99, 111, 109),
          Bt(115, 116, 97, 99, 107, 111, 118, 101, 114, 102, 108, 111, 119, 46, 99, 111, 109),
          Bt(115, 116, 97, 99, 107, 101, 120, 99, 104, 97, 110, 103, 101, 46, 99, 111, 109),
          Bt(115, 116, 117, 100, 105, 111, 102, 114, 101, 105, 103, 104, 116, 46, 99, 111, 109),
          Bt(119, 101, 98, 99, 111, 110, 116, 97, 105, 110, 101, 114, 46, 105, 111),
          Bt(106, 115, 102, 105, 100, 100, 108, 101, 46, 110, 101, 116),
        ],
        n = function () {
          if (e)
            if ('loading' === document.readyState || 'interactive' === document.readyState)
              ...
              e &&
                ...
                (console.log(
                  Bt(37, 99, 87, 97, 114, 110, 105, 110, 103),
                  Bt(
                    102,
                    111,
                    110,
                ...
                console.log(
                  Bt(65, 32, 116, 114, 105, 97, 108, 32, 118, 101, 114, 115, 105, 111, 110, 32, 111, 102, 32) +
                    'MotionPathHelper' +
                    Bt(
                      32,
                      105,
        ...
        setTimeout(function () {
          e &&
            (window.location.href =
              Bt(104, 116, 116, 112, 115, 58, 47, 47) +
              Ft +
              Bt(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47) +
              '?plugin=MotionPathHelper&source=trial');
        }, 4e3);
  ...
  Qt = (t, e) => {
    let s = It.createElementNS
      ? It.createElementNS((e || 'http://www.w3.org/1999/xhtml').replace(/^https/, 'http'), t)
      : It.createElement(t);
  ...
  Jt = (t, e, s) =>
    Kt(t) && $t.test(t)
      ? It.querySelector(t)
      : Array.isArray(t)
      ? zt(jt([{ x: Xt.getProperty(e, 'x'), y: Xt.getProperty(e, 'y') }, ...t], s))
  ...
  ee = (t, e) => {
    ...
    (Ot = window),
      ...
      Xt && ((Vt = Xt.plugins.motionPath), (se.PathEditor = Lt), (Gt = Xt.core.context || function () {})),
      Vt
        ? ((Wt = Qt('textarea')),
    ...
    t instanceof Xt.core.Tween
      ...
      (a = ((t) => {
        let e = t.getBoundingClientRect(),
          s = qt.clientTop - (Ot.pageYOffset || qt.scrollTop || Yt.scrollTop || 0),
      ...
      l && !i && (i = Jt(l.vars.motionPath.path || l.vars.motionPath, s, l.vars.motionPath)),
      ...
      (_._gsHelper = f),
      (Xt.utils.toArray(e.container)[0] || Yt).appendChild(_),
      ((t, e, s) => {
        ...
        _,
        () => f.getString(),
        () => Xt.fromTo(_, { backgroundColor: 'white' }, { duration: 0.5, backgroundColor: 'rgba(85, 85, 85, 0.6)' })
      ),
      ...
      h
        ...
        : ((c = (n && s.ownerSVGElement && s.ownerSVGElement.getAttribute('xmlns')) || 'http://www.w3.org/2000/svg'),
          n
            ? ((h = s.ownerSVGElement),
              (d = s.getBBox()),
              (g = ((t) => (t.transform.baseVal.consolidate() || te).matrix)(s)),
              (o = g.e),
              (r = g.f),
              (m.x = d.x),
              (m.y = d.y))
          ...
          (i.style.cssText =
            ...
            (e.pathOpacity || 0.6)),
          h.appendChild(i)),
      (m.x || m.y) && Xt.set(i, { x: m.x, y: m.y }),
      'selected' in e || (e.selected = !0),
      'anchorSnap' in e ||
        (e.anchorSnap = (t) => {
          t.x * t.x + t.y * t.y < 16 && (t.x = t.y = 0);
        }),
      (u = l && 'nested' === l.parent.data ? l.parent.parent : l),
      (e.onPress = () => {
        u.pause(0);
      }),
      (p = () => {
      ...
      e.center && Xt.set(s, { transformOrigin: '50% 50%', xPercent: -50, yPercent: -50 }),
      l
      ...
      (this.kill = this.revert =
        () => {
          this.editor.kill(),
            ...
            n || (h.parentNode && h.parentNode.removeChild(h)),
            u && u.revert();
        });
  }
  getString() {
